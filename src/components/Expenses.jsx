				...
				<div className="container">
					<div className="row">
						<div className="col text-center">
							<h1 className="text-center flex-fill">{this.state.name}
							</h1>
							<div>
								<button
									className="btn btn-info"
									onClick={() => window.navigator.clipboard.writeText(this.inviteLink())}>
					...
					<div className="row">
						{this.state.expenses.map((expense) => (
							<div className="col-12 col-sm-6 cold-md-4 col-lg-3 my-2" key={expense._id}>
					...
					<div className="row">
						...
						{this.state.members?.map((user) => (
							<div className="col-12" key={user._id}>
								<div className="card w-90 m-1 border-info border-rounded w-100">
									<div className="card-body">
										<h5 className="card-title">{user.name}</h5>
										<p className="card-text">{"Spend " + this.userSum(user) + "$"}</p>
